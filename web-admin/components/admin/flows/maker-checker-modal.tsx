...
/**
 * MakerCheckerModal — flow modal dual-control step (design template line 1214). An
 * amber shield-check icon, "enters Pending approval" copy, a from→to change-preview
 * table (old struck-through in danger tone, new in success tone), and Cancel / dark
 * "Submit for approval" CTA. Encodes the dual-control invariant: a sensitive config
 * change never takes effect until a second admin approves. Presentation only —
 * `onSubmit` hands off to the caller's real approval-request mutation.
 *
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogDescription className="my-2.5 mb-4 text-[13px] leading-normal text-ink2">
          This is a dual-control change. It will enter <b>Pending approval</b>{" "}
          and requires a second admin to approve before it takes effect.
        </DialogDescription>
