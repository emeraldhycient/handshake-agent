 ...
 *
 * The legacy completeVerification / completeVerificationForUser methods (and
 * their PinService dependency) were retired — see
...
/** Creates a mock IIdentityRepository with an unlinked-Contact default. */
