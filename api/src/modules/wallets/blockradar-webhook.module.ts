/**
 * BlockradarWebhookModule — wires the Blockradar deposit webhook controller
 * that credits on-chain deposits and sends WhatsApp receipts (R2).
 *
...
@Module({
  imports: [WalletsModule, IdentityModule, WhatsAppSenderModule],
